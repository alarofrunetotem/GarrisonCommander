...
if (L) then
L["Always counter increased resource cost"] = "Всегда счетчик увеличение стоимости ресурсов"
L["Always counter increased time"] = "Всегда счетчик увеличение времени"
L["Always counter kill troops (ignored if we can only use troops with just 1 durability left)"] = "Всегда счетчик убить войск (игнорируется, если мы можем использовать только войска только с 1 долговечностью слева)"
L["Always counter no bonus loot threat"] = "Всегда противостоять не бонусную лута угрозы"
L["Better parties available in next future"] = "Лучше стороны доступны в ближайшем будущем"
L["Building Final report"] = "Создание Окончательный отчет"
L["Capped %1$s. Spend at least %2$d of them"] = "Ограничено% 1 $ s. Проведите по крайней мере 2% $ D из них"
L["Changes the sort order of missions in Mission panel"] = "Изменение порядка сортировки миссий в панели Миссии"
L["Complete all missions without confirmation"] = "Завершите все миссии без подтверждения"
L["Configuration for mission party builder"] = "Конфигурация для миссии партийного строителя"
L["Dont kill Troops"] = "Не убить войск"
L["Duration reduced"] = "Длительность уменьшена"
L["Duration Time"] = "Продолжительность"
L["Expiration Time"] = "Время истечения"
L["Favours leveling follower for xp missions"] = "Милости выравнивания повторитель для Xp миссий"
L["General"] = "Основные"
L["Global approx. xp reward"] = "Максимум прибл. хр награда'"
L["HallComander Quick Mission Completion"] = "HallComander Быстрое завершение миссий"
L[ [=[If you %s,  you will lose them
Click on %s to abort]=] ] = "Если вы % с, вы потеряете их. Нажмите на % S, чтобы прервать"
L[ [=[If you %s, you will lose them
Click on %s to abort]=] ] = "Если вы % с, вы потеряете их. Нажмите на % S, чтобы прервать"
L["Keep cost low"] = "Учитывать низкую стоимость"
L["Keep extra bonus"] = "Сохранить доп. добычу"
L["Keep time short"] = "Сохранить уменьшение времени"
L["Keep time VERY short"] = "Сохранить время очень коротким"
L["Level"] = "Уровень"
L["Make Order Hall Mission Panel movable"] = "  Разрешить перемещать панель Order Hall"
L["Maximize xp gain"] = "Максимальное усиление хр"
L["Missions"] = "Миссии"
L["No follower gained xp"] = "Нет соратников получивших опыт"
L["Nothing to report"] = "Нечего докладывать"
L["Notifies you when you have troops ready to be collected"] = "Уведомляет, когда войска готовы для сбора"
...
L["Upgrading to |cff00ff00%d|r"] = "Обновление до | cff00ff00% d |"
L["Use combat ally"] = "Использовать боевого соратника"
